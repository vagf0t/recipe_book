var CategorySearchForm = createReactClass({
    handleSearch: function() {
        var category_query = ReactDOM.findDOMNode(this.refs.category_query).value;
        ...
        $.ajax({
            ...
            success: function(recipes) {
                self.props.handleSearch(recipes,
                    query,
                    name_query,
                    title_query,
                    category_query,
